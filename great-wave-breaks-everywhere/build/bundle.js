...
var app = (function () {
    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			img = element("img");
    			if (!src_url_equal(img.src, img_src_value = /*img*/ ctx[18].link)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", img_alt_value = /*img*/ ctx[18].title);
    			attr_dev(img, "class", "svelte-xzd59x");
    			add_location(img, file, 84, 12, 2877);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*images*/ 1 && !src_url_equal(img.src, img_src_value = /*img*/ ctx[18].link)) {
    				attr_dev(img, "src", img_src_value);
    			}

    			if (dirty & /*images*/ 1 && img_alt_value !== (img_alt_value = /*img*/ ctx[18].title)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(84:8) {#each images as img}",
    		ctx
    	});
    ...
    // (93:12) {#if getNodeById(link.source) && getNodeById(link.target)}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(line, "x1", line_x__value = /*getLinkCoordinates*/ ctx[6](/*link*/ ctx[15]).x1);
    			attr_dev(line, "y1", line_y__value = /*getLinkCoordinates*/ ctx[6](/*link*/ ctx[15]).y1);
    			attr_dev(line, "x2", line_x__value_1 = /*getLinkCoordinates*/ ctx[6](/*link*/ ctx[15]).x2);
    			attr_dev(line, "y2", line_y__value_1 = /*getLinkCoordinates*/ ctx[6](/*link*/ ctx[15]).y2);
    			attr_dev(line, "stroke", "#fff");
    			attr_dev(line, "stroke-opacity", "0.6");
    			attr_dev(line, "stroke-width", "2");
    			attr_dev(line, "class", "svelte-xzd59x");
    			add_location(line, file, 93, 16, 3163);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, line, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*links*/ 8 && line_x__value !== (line_x__value = /*getLinkCoordinates*/ ctx[6](/*link*/ ctx[15]).x1)) {
    				attr_dev(line, "x1", line_x__value);
    			}

    			if (dirty & /*links*/ 8 && line_y__value !== (line_y__value = /*getLinkCoordinates*/ ctx[6](/*link*/ ctx[15]).y1)) {
    				attr_dev(line, "y1", line_y__value);
    			}

    			if (dirty & /*links*/ 8 && line_x__value_1 !== (line_x__value_1 = /*getLinkCoordinates*/ ctx[6](/*link*/ ctx[15]).x2)) {
    				attr_dev(line, "x2", line_x__value_1);
    			}

    			if (dirty & /*links*/ 8 && line_y__value_1 !== (line_y__value_1 = /*getLinkCoordinates*/ ctx[6](/*link*/ ctx[15]).y2)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(93:12) {#if getNodeById(link.source) && getNodeById(link.target)}",
    		ctx
    	});
    ...
    // (91:8) {#each links as link}
    function create_each_block_1(ctx) {
    	let t_value = console.log(/*link*/ ctx[15]) + "";
    	let t;
    	let show_if = /*getNodeById*/ ctx[5](/*link*/ ctx[15].source) && /*getNodeById*/ ctx[5](/*link*/ ctx[15].target);
    	let if_block_anchor;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*links*/ 8 && t_value !== (t_value = console.log(/*link*/ ctx[15]) + "")) set_data_dev(t, t_value);
    			if (dirty & /*links*/ 8) show_if = /*getNodeById*/ ctx[5](/*link*/ ctx[15].source) && /*getNodeById*/ ctx[5](/*link*/ ctx[15].target);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(91:8) {#each links as link}",
    		ctx
    	});
    ...
    // (107:8) {#each nodes as node}
    function create_each_block(ctx) {
    	let text_1;
    	let t_value = /*node*/ ctx[12].id + "";
    	let t;
    	let text_1_x_value;
    	let text_1_y_value;
    	...
    	function mouseover_handler() {
    		return /*mouseover_handler*/ ctx[8](/*node*/ ctx[12]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text$1(t_value);
    			attr_dev(text_1, "x", text_1_x_value = /*node*/ ctx[12].x);
    			attr_dev(text_1, "y", text_1_y_value = /*node*/ ctx[12].y);
    			attr_dev(text_1, "font-size", text_1_font_size_value = `${10 + /*node*/ ctx[12].count}px`);
    			attr_dev(text_1, "fill", "steelblue");
    			attr_dev(text_1, "text-anchor", "middle");
    			attr_dev(text_1, "alignment-baseline", "middle");
    			attr_dev(text_1, "class", "svelte-xzd59x");
    			add_location(text_1, file, 107, 12, 3627);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(text_1, "mouseover", mouseover_handler, false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*nodes*/ 4 && t_value !== (t_value = /*node*/ ctx[12].id + "")) set_data_dev(t, t_value);

    			if (dirty & /*nodes*/ 4 && text_1_x_value !== (text_1_x_value = /*node*/ ctx[12].x)) {
    				attr_dev(text_1, "x", text_1_x_value);
    			}

    			if (dirty & /*nodes*/ 4 && text_1_y_value !== (text_1_y_value = /*node*/ ctx[12].y)) {
    				attr_dev(text_1, "y", text_1_y_value);
    			}

    			if (dirty & /*nodes*/ 4 && text_1_font_size_value !== (text_1_font_size_value = `${10 + /*node*/ ctx[12].count}px`)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(107:8) {#each nodes as node}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h1 = element("h1");
    			span0 = element("span");
    			span0.textContent = "Hokusai's legendary ";
    			span1 = element("span");
    			span1.textContent = "\"Great Wave off Kanagawa\" ";
    			span2 = element("span");
    			span2.textContent = "can be";
    			t3 = space();
    			input = element("input");
    			t4 = space();
    			...
    			add_location(span0, file, 78, 8, 2536);
    			attr_dev(span1, "class", "italic svelte-xzd59x");
    			add_location(span1, file, 78, 41, 2569);
    			add_location(span2, file, 78, 96, 2624);
    			attr_dev(h1, "class", "svelte-xzd59x");
    			add_location(h1, file, 78, 4, 2532);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "anything");
    			attr_dev(input, "class", "svelte-xzd59x");
    			add_location(input, file, 79, 4, 2654);
    			attr_dev(button, "class", "svelte-xzd59x");
    			add_location(button, file, 80, 4, 2726);
    			attr_dev(div0, "class", "image-container svelte-xzd59x");
    			add_location(div0, file, 82, 4, 2805);
    			attr_dev(svg, "width", "400");
    			attr_dev(svg, "height", "600");
    			attr_dev(svg, "class", "svelte-xzd59x");
    			add_location(svg, file, 88, 4, 2957);
    			add_location(div1, file, 87, 4, 2947);
    			attr_dev(div2, "class", "container svelte-xzd59x");
    			add_location(div2, file, 81, 4, 2777);
    			attr_dev(main, "class", "svelte-xzd59x");
    			add_location(main, file, 77, 0, 2521);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input, /*userQuery*/ ctx[1]);
    			append_dev(main, t4);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*fetchImages*/ ctx[4], false, false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*userQuery*/ 2 && input.value !== /*userQuery*/ ctx[1]) {
    				set_input_value(input, /*userQuery*/ ctx[1]);
    			}

    			if (dirty & /*images*/ 1) {
    				each_value_2 = /*images*/ ctx[0];
    				validate_each_argument(each_value_2);
    				let i;
    			...
    			if (dirty & /*getLinkCoordinates, links, getNodeById, console*/ 104) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	async function fetchImages() {
    		try {
    			const response = await axios$1.get(`http://localhost:3000/api/images?q=${userQuery}`);
    			$$invalidate(0, images = response.data);
    	...
    	function addOrUpdateNode(query) {
    		...
    		if (existingNode) {
    			...
    			$$invalidate(2, nodes = [...nodes, { id: query, count: 1 }]);
    	...
    	function restartSimulation() {
    		...
    		simulation$1 = simulation(nodes).force("link", link$2(links).id(d => d.id).distance(100)).force("charge", manyBody().strength(-200)).force("center", center(200, 300)).force("gravity", radial$1(d => 300 - d.count * 20, 200, 300)).on("tick", () => {
    			// Trigger Svelte reactivity by reassigning the nodes array
    			$$invalidate(2, nodes = [...nodes]); // Center of the SVG
    			// Pull higher-count nodes closer to the center
    		});
    	}
    	...
    	function input_input_handler() {
    		...
    		$$invalidate(1, userQuery);
    	}

    	const mouseover_handler = node => console.log(node.id);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('userQuery' in $$props) $$invalidate(1, userQuery = $$props.userQuery);
    		if ('nodes' in $$props) $$invalidate(2, nodes = $$props.nodes);
    		if ('links' in $$props) $$invalidate(3, links = $$props.links);
    		if ('simulation' in $$props) simulation$1 = $$props.simulation;
    	};
