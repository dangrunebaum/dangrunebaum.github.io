...
function setup() {
  ...
  text("The vast size of the Metropolitan Museum of Art's collection presented the opportunity to utilize it as a lens for understanding the \ninteraction of civilizations over time. The goal of this project was to learn if its almost 500,000 objects contained a hidden story that could \nbe uncovered with visualization techniques.The Top 10 Cultures represent 145,338 objects, or about one-third of the Met's Collection.", 125, marginTop + 1030);
  textSize(15);
