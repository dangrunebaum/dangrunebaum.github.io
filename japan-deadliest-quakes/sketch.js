...
function setupMap(){
    ...
    // load Leaflet map tiles – choose from the different providers demoed here:
    ...
    // call  function (defined below) that populates the maps with markers based on the table contents
    drawDataPoints();
}
