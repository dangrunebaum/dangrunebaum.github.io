...
function setupBottom(guitarsBottom) {
    ...
    // image(fenderSound, 801, WTopMargin + 351);
    // image(gibsonSound, 801, WTopMargin + 651);

    // function onMouseOver() {
    // if (((mouseX >= 260 && mouseX <= 580) && (mouseY >= WTopMargin + 425 && mouseY <= WTopMargin + 475)) || ((mouseX >= 275 && mouseX <= 595) && (mouseY >= WTopMargin + 715 && mouseY <= WTopMargin + 765)))
    //     addClass(pClass);
    // else
    //     removeClass(pClass);
